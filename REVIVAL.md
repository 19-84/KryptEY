...
**Tests: 31 → 617 (616 run, 1 permanently skipped), all passing.** Debug and release both assemble; dependency verification pins 387
...
- 617 JVM tests, including an end-to-end conversation across all four phases and a real MITM
