...
**Tests: 31 → 543, all passing.** Debug and release both assemble; dependency verification pins 387
...
- 543 JVM tests, including an end-to-end conversation across all four phases and a real MITM
