...
**Tests: 31 → 408, all passing.** Debug and release both assemble; dependency verification pins 382
...
- 408 JVM tests, including an end-to-end conversation across all four phases and a real MITM
