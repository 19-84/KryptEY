...
**Tests: 31 → 587 (586 run, 1 permanently skipped), all passing.** Debug and release both assemble; dependency verification pins 387
...
- 587 JVM tests, including an end-to-end conversation across all four phases and a real MITM
