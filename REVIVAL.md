...
**Tests: 31 → 410, all passing.** Debug and release both assemble; dependency verification pins 382
...
- 410 JVM tests, including an end-to-end conversation across all four phases and a real MITM
